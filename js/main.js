// localStorage.getItem - return null if there is nothing there(in todoList in our case) 
// ? - mean if this is true. So if there is something in todoList execute JSON.parse(localStorage.getItem('todoList'))
// : - mean otherwise. So if todoList is empty initialize data object with empty todo and completed tables
